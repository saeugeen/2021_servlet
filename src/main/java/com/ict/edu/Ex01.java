...
//URL 매핑 : 해당 페이지를 웹에서 접근할 수 있는 주소
...
public class Ex01 extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//클라이언트가 정보를 요청할때 요청 방식에 따라 알맞는 메소드를 호출하는 역할을 한다.
		//요청 방식 : - get방식이면 doGet()으로 이동
		//		   - post방식이면 doPost()로 이동
		//  ** get방식(생략 가능) : 정보를 http패킷의 head에 담아서 보낸다.
		//						주소창에 해당 주소가 보인다.
		//						속도가 빠르다. 적은 양을 전달할때 적합하지만 보안에 취약하다.
		//	** Post방식 		  : 정보를 http패킥의 body에 담아서 보낸다.
		//						주소창에 해당 정보가 보이지 않는다.
		//						속도는 get방식보다 느리다. 많은 양을 전달 할 때 적합,get보다 보안성이 좋다.
